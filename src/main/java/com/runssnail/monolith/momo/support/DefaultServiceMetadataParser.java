 ...
 * @author zhengwei
 */
public class DefaultServiceMetadataParser extends AbstractServiceMetadataParser {

    private static final DefaultServiceMetadataParser INSTANCE      = new DefaultServiceMetadataParser();
    ...
    public ServiceMetadata parse(Element element, ParserContext parserContext) {
        ...
        DefaultServiceMetadata metadata = createServiceMetadata();
        metadata.setId(id);
    ...
    protected DefaultServiceMetadata createServiceMetadata() {
        return new DefaultServiceMetadata();
    }
